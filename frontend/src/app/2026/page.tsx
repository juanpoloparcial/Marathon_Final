        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            ...
            <nav className="hidden lg:flex items-center gap-8">
              ...
              <Link href="/2026" className="text-white hover:text-[#00B248] transition-colors uppercase font-semibold tracking-wide">
                2026
              </Link>
              <Link href="/2025" className="text-white hover:text-[#00B248] transition-colors uppercase font-semibold tracking-wide">
                2025
              </Link>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-start">
            ...
            <div className="space-y-8">
              {/* Marathon */}
              <div>
                <h3 className="text-3xl font-bold text-[#00B248] mb-2">Maratón | 21Km</h3>
              ...
              {/* Half Marathon */}
              <div>
                <h3 className="text-3xl font-bold text-[#00B248] mb-2">Media Maratón | 10Km</h3>
                <div className="flex items-center gap-2 text-gray-300">
              ...
              {/* 7K Run */}
              <div>
                <h3 className="text-3xl font-bold text-[#00B248] mb-2">Corrida | 5Km</h3>
                <div className="flex items-center gap-2 text-gray-300">
              ...
              {/* Date & Location */}
              <div>
                <h3 className="text-3xl font-bold text-[#00B248] mb-4">Fecha | Lugar</h3>
              ...
              {/* Kit Pickup */}
              <div>
                <h3 className="text-3xl font-bold text-[#00B248] mb-4">Entrega De Kits</h3>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <button className="bg-[#007E33] text-black px-8 py-4 font-bold uppercase hover:bg-[#00B248] transition-all hover:scale-105 shadow-lg hover:shadow-xl">
                  INSCRIPCIONES
                </button>
                <button className="bg-[#007E33] text-black px-8 py-4 font-bold uppercase hover:bg-[#00B248] transition-all hover:scale-105 shadow-lg hover:shadow-xl">
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <button className="bg-[#007E33] text-black px-8 py-4 font-bold uppercase hover:bg-[#00B248] transition-all hover:scale-105">
                  UBICACIÓN
                </button>
                <button className="bg-[#007E33] text-black px-8 py-4 font-bold uppercase hover:bg-[#00B248] transition-all hover:scale-105">
                  REGLAMENTO
